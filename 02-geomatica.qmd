...
1.  Cargue el siguiente [Modelo de Elevación Digital](https://github.com/Aloniss/taller.github.io/raw/refs/heads/master/recursos/descarga/imagenElevationVal.tif) y grafíquelo.

2.  De la misma manera, descargue la siguiente [imagen Sentinel](https://github.com/Aloniss/taller.github.io/raw/refs/heads/master/recursos/descarga/senImagenFullBands.tif) y grafique cada banda que posea.   

3.  De acuerdo a la teoría del color, grafique distintas composiciones que representen distintas características específicas del entorno. Puede usar la siguente [página](https://mappinggis.com/2019/05/combinaciones-de-bandas-en-imagenes-de-satelite-landsat-y-sentinel/) para guiarse.


4. Descarga esta [imagen](https://github.com/Aloniss/taller.github.io/raw/refs/heads/master/recursos/descarga/img-rgb.tif) y visualiza la composición y observa sus histogramas.
    i) Aplica un realce lineal.

    ii) Realiza un recorte de la imagen con las coordenadas que se listan abajo, aplica un realce y observa sus histogramas.
    - `xmin` = 697030.5734
    - `xmax` = 700721.5109
    - `ymin` = 5494727.9939
    - `ymax` = 5496852.5981

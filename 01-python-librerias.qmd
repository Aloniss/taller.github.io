...
1. Descargue y cargue los datos vectoriales disponibles en este [enlace](https://figshare.com/ndownloader/files/49550784). Una vez descargado, intente graficarlos.
...
3. Dadas las provincias de Chile continental (disponibles en el siguiente [enlace](https://figshare.com/ndownloader/files/50316978)), consulte la cantidad de puntos de ignición por región a través del componente espacial entre capas. Observe si hay diferencias con lo obtenido con el ejercicio anterior.
